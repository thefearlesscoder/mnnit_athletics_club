...
const NormalUserRegisterForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(`${API}/auth/normal_user/signup`, formData);
  ...
  return (
    ...
    >
      ...
      <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '1.2rem' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.4rem' }}>
          <label style={{ fontSize: '0.85rem', color: 'var(--text-secondary)' }}>Registration Number</label>
          <input
            type="text"
        ...
        >
          {loading ? 'Submitting...' : 'Register as Normal User'}
        </button>
      </form>
    </motion.div>
  );
...
export default NormalUserRegisterForm;
